...
public class GradeSheet {
    ...
    public static void Grade() {
        ...
        else if ((avg >= 80) && (avg < 90)) System.out.println("Your grade is B");
        else if ((avg >= 70) && (avg < 80)) System.out.println("Your grade is C");
        else if ((avg >= 60) && (avg < 70)) System.out.println("Your grade is D");
        else if ((avg >= 50) && (avg < 60)) System.out.println("Your grade is E");
